...
const FileUpload = (props: FileUploadProps) => {
  ...
  const handleUpload = async () => {
    ...
    let { data: bucketList, error: listBucketsError } = await supabase.storage.listBuckets();
    ...
    const { data, error: uploadError } = await supabase.storage.from(userID).upload(filePath, file);
